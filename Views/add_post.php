<?php
    ...
    $getPid = "SELECT id, email FROM users WHERE email='$email';";
    ...
    while ($row = mysqli_fetch_array($getPidResult)){
        if ($row['email'] == $email){
            ...
            $sql = "INSERT INTO posts (post_id, post_title, post_body, post_image) VALUES ('" . $_SESSION['postID'] . "'," . "'" . $safeTitle . "',". "'" . $safeBody . "'," . "'" . $safeImage . "');";
